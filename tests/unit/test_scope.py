...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("369", [369]),
        ("401", [401]),
        ("all", [119, 125, 190, 338, 362, 367, 369, 377, 401, 415, 416, 476, 78, 134, 676, 732, 787]),
    ],
)
...
def test_valid_tokens_constant_complete():
    assert set(VALID_TOKENS) == {"119", "125", "190", "338", "362", "367", "369", "377", "401", "415", "416", "476", "78", "134", "676", "732", "787", "all"}
