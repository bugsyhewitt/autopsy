...
def test_list_checks_text_runs_without_binary(monkeypatch, capsys):
    ...
    for cwe in (22, 78, 119, 125, 190, 338, 362, 367, 369, 377, 401, 415, 416, 476, 134, 676, 732, 787):
...
def test_list_checks_json_is_machine_readable(capsys):
    ...
    assert cwes == {22, 78, 119, 125, 190, 338, 362, 367, 369, 377, 401, 415, 416, 476, 134, 676, 732, 787}
